...
# Requête d'insertion
insert_query = "INSERT INTO customers (id_customer, first_name, last_name, email, child_number, nb_collect, city_name_id, csp_name_id) VALUES (DEFAULT, %s, %s, %s, %s, DEFAULT, DEFAULT, DEFAULT);"
